...
#define DEFAULT_lighterProgressColor [NSColor colorWithCalibratedRed:237.0/255.0 green:237.0/255.0 blue:237.0/255.0 alpha:1.0]
#define DEFAULT_darkerProgressColor [NSColor colorWithCalibratedRed:237.0/255.0 green:237.0/255.0 blue:237.0/255.0 alpha:1.0]
#define DEFAULT_lighterStripeColor [NSColor colorWithCalibratedRed:237.0/255.0 green:237.0/255.0 blue:237.0/255.0 alpha:1.0]
#define DEFAULT_darkerStripeColor [NSColor colorWithCalibratedRed:237.0/255.0 green:237.0/255.0 blue:237.0/255.0 alpha:1.0]
...
-(void)drawRect:(NSRect)dirtyRect {
    ...
    if ( self.isDisplayedWhenStopped || value)
    {
        [self drawBezel];
    }
